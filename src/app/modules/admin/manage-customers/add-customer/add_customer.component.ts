            ...
            this.signUpService.create(this.user)
                .subscribe(UserDetails => {
                    if (UserDetails) {
                        ...
                        this.user = { email: '', password: '' };
<<<<<<< HEAD:src/app/modules/admin/manage-customer/add-customer/add_customer.component.ts
                        this.router.navigateByUrl('admin/manage-users');
=======
                        this.router.navigateByUrl('admin/manage-customers');
>>>>>>> ea5c9d0dafb834312571173cbb596b026f00f91b:src/app/modules/admin/manage-customers/add-customer/add_customer.component.ts
                    }
                    resolve();
                });
        });
