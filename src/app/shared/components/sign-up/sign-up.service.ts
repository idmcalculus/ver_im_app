...
create(user: User): Observable<any> {
    return this.httpService.postRequest(`create_user?email=${user.email}
...
=======
    create(user:User): Observable<any> {
        ...
        return this.httpService.postRequest(`create?email=${user.email}&authentication_type=${user.authentication_type}
        &first_name=${user.first_name}&last_name=${user.last_name}
        &phone_number=${user.phone_number}&gender=${user.gender}
        &home_address=${user.home_address}
        &month_of_birth=${user.month_of_birth}
